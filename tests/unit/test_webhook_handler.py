...
from src.webhook_handler import WebhookEvent, CrossSeedForwarder, WebhookHandler
from src.config import QguardarrConfig, GlobalSettings, CrossSeedSettings
...
class TestWebhookHandler:
    ...
    async def test_handle_webhook_queue_full(self, webhook_handler):
        ...
        # Mock request
        mock_request = AsyncMock(spec=Request)
        mock_request.form = AsyncMock(return_value={"event": "complete", "hash": "test123"})
    ...
    async def test_process_completion_event(self, webhook_handler):
        ...
        try:
            ...
            webhook_handler.allocation_engine.mark_torrent_for_check.assert_called_with("test123")
    ...
    async def test_process_add_event(self, webhook_handler):
        ...
        try:
            ...
            webhook_handler.allocation_engine.mark_torrent_for_check.assert_called_with("test123")
            webhook_handler.allocation_engine.schedule_tracker_update.assert_called_with("http://example.com/announce")
    ...
    async def test_process_delete_event(self, webhook_handler):
        ...
        try:
            ...
            webhook_handler.allocation_engine.handle_torrent_deletion.assert_called_with("test123")
    ...
    async def test_process_event_error_handling(self, webhook_handler):
        ...
        try:
            ...
            webhook_handler.allocation_engine.mark_torrent_for_check.side_effect = Exception("Test error")
